...
public class ExtratorTWD extends Extrator{
  ...
  public List<ConteudoTWD> extraiTWD(String json){
    ...
    .map((atributos) -> new ConteudoTWD(atributos.get("name"), atributos.get("image"), atributos.get("firstSeason"), atributos.get("community"), atributos.get("gunType"), atributos.get("alive")))
    .toList();
  }
